...
const NOTIFICATION_HELPER = Me.dir.get_child('packagekit-notification.js');
...
function gi_typelib_filename(lib, version) {
    return `${lib}-${version}.typelib`;
}
...
function resolve_packages(manifest, lib_versions, os_ids) {
    ...
    for (const [lib, version] of Object.entries(lib_versions)) {
        ...
        if (pkg)
            ...
            unresolved.add(gi_typelib_filename(lib, version));
    }
