...
const MonitorList = backport.GObject.registerClass(
    {
        GTypeName: 'DDTermPrefsMonitorList',
    },
    class MonitorList extends Gio.ListStore {
        _init(params) {
            super._init({
...
const GtkListModelAdapter = backport.GObject.registerClass(
    {
        GTypeName: 'DDTermGtkListModelAdapter',
        Properties: {
    ...
    class GtkListModelAdapter extends Gtk.ListStore {
        _init(params) {
            super._init(params);
...
var Widget = backport.GObject.registerClass(
    ...
    class PrefsPositionSize extends Gtk.Grid {
        _init(params) {
            ...
            const adapter = new GtkListModelAdapter({ source: monitor_list });
            ...
            const monitor_added_handler_id = adapter.connect('row-inserted', () => {
                this.monitor_combo.active_id = this.settings['window-monitor-connector'];
            });
